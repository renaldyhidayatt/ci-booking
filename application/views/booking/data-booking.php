						...
						<tr>
							...
							<td class="border border-gray-800 p-2">
								<a href="t.id_buku" onclick="confirm('Yakin tidak Jadi Booking t.judul_buku')">
									<i class=" focus:outline-none text-white bg-red-800 hover:bg-red-900 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-700 dark:hover:bg-red-800 dark:focus:ring-red-900 "></i>
								</a>
							</td>
						</tr>
					<?php
